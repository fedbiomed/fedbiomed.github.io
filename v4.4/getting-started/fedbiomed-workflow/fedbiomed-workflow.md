...
<div class="img-content centered">
    <img src="/assets/img/diagrams/fedbiomed-worflow-step1.jpg" style="max-width: 800px; max-heigth: 400px"></img>
...
<div class="img-content centered">
    <img src="/assets/img/diagrams/fedbiomed-workflow-step2-loading_data.jpg" width="75%" height="75%"></img>
...
<!--
<div class="img-content centered" style="display:flex; vertical-align:middle;">
    <div class="img-content centered" style="display:flex; vertical-align:middle; align-items:center;">
        <p>
            <img src="/assets/img/untrained_model.png"/>
        </p>
    ...
    <div class="img-content centered" style="display:flex; vertical-align:middle; align-items:center;">
        <p>
            <img src="/assets/img/trained_model.png"/>
        </p>
        <p style="font-size: 14px;">
            Model updated (trained on Nodes local updates)
        </p>
    </div>
</div>
-->

...
You can read the documentation for <a href="/user-guide/researcher/training-data" target="_blank">"training data"</a> to
...
<a href="/user-guide/researcher/experiment" target="_blank">model and training</a> arguments. For example, if the 
...
the <a href="/user-guide/researcher/experiment" target="_blank">experiment</a> through the network component.    
...
[experiment](/user-guide/researcher/experiment) can upload and download the model parameters. Indeed, each framework 
